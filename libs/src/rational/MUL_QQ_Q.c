...
{    int ** fraction = (int**)malloc(2 * sizeof(int*)); // it's a fraction { fraction[0] - numerator  fraction[1] - denominator}
    ...
    fraction[1] = MUL_NN_N(fractionMultiplied[1],fractionMultiplier[1]); // denominator of composition
    return  fraction;
}
